  ...
  return (
    <div ref={containerRef} className="fixed inset-0 -z-10">
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(circle 800px at var(--mouse-x, 50%) var(--mouse-y, 50%), rgba(20, 107, 255, 0.1), transparent)`
        }}
      />
      ...
      {/* Vignette */}
      <div className="absolute inset-0 bg-gradient-radial from-transparent via-transparent to-dark-900/90" />
    </div>
  );
}